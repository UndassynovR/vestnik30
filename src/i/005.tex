...
{\bfseries PREDICTIVE MODEL OF LABORATORY CONTROL OF CHEMICAL COMPOSITION
OF MINING AND METALLURGICAL PRODUCTS}

{\bfseries \tsp{1} L.
Akisheva}\fig{i/image1}[]{\bfseries \envelope 
, \tsp{2}А.
Utegenov}\fig{i/image1}[]{\bfseries ,
\tsp{2}А.
Kyzken}\fig{i/image1}[]

\emph{\tsp{1}Nazarbayev Intellectual School, Astana,
Kazakhstan,}
...
{\bfseries ПРЕДИКТИВНАЯ МОДЕЛЬ ЛАБОРАТОРНОГО КОНТРОЛЯ ХИМИЧЕСКОГО СОСТАВА
ПРОДУКЦИИ ГОРНОМЕТАЛЛУРГИЧЕСКОГО ПРОИЗВОДСТВА}

{\bfseries \tsp{1}Л. Акишева\envelope  ,
\tsp{2}А. Утегенов, \tsp{2}А.Кызкен}

\emph{\tsp{1}Назарбаев интеллектуальная школа, Астана,
Казахстан,}

\emph{\tsp{2}Казахский университет технологии и бизнеса
...
{\bfseries ТАУ-КЕН МЕТАЛЛУРГИЯ ӨНДІРІСІ ӨНІМДЕРІНІҢ ХИМИЯЛЫҚ ҚҰРАМЫН
ЗЕРТХАНАЛЫҚ БАҚЫЛАУДЫҢ БОЛЖАМДЫ МОДЕЛІ}

{\bfseries \tsp{1}Л. Акишева\envelope ,
\tsp{2}А. Өтегенов, \tsp{2}А. Кызкен}

\emph{\tsp{1}Назарбаев зияткерлік мектебі, Астана,
Қазақстан,}
...
\emph{μ-} is the average value of the indicator for open sources;

σ -is an estimate of the standard deviation;
...
{\bfseries Fig.1- Block diagram of the hybrid dataset formation}

\emph{Y=f(X)+ε,} (2)

where

\emph{Y}= \{\emph{Cr, C, Si, Mn, P, S}\} is the predicted chemical
composition;

\emph{X-} is a set of technological and raw material parameters;
...
{\bfseries Table 1 - Comparison of models}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1775}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2056}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2056}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2056}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2056}}@{}}
%% \toprule\noalign{}
...
{\bfseries Table 2 - Metrics of the ensemble model}

%% \begin{longtable}[]{@{}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2305}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2565}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2565}}
%%   >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.2565}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Fig.2 - Comparison of Model Accuracy for Chromium Prediction}
...
{\bfseries Fig.3 - Predicted Vs Actual Chromium Content (Stacking Model)}
...
{\bfseries Fig.4 - Feature Importance in the Stacking Model}
...
{\bfseries Table 3 - Indicators of model error analysis}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4843}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5157}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Indicator}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Table 4 - Sensitivity analysis of the model}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5565}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4435}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Parameter}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Changing the Cr forecast, \%}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
...
{\bfseries Table 5 - Comparison with regulatory tolerances}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.7231}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2769}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Indicator}
...
{\bfseries Table 6 - Practical effect of implementation}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.5767}}
%%   >{\centering\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.4233}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Indicator}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
...
{\bfseries Fig.5 - Distribution of forecast errors}
...
{\bfseries Fig.6 - Maximum deviation of the forecast of Cr content}
...
{\bfseries Fig.7-Architecture of an intelligent laboratory control system
for the chemical composition}

{\bfseries of metallurgical enterprise products}
...
{\bfseries Fig.8 - Control data based on the ensemble model}
...
{\bfseries Fig.9 - Laboratory control results}
