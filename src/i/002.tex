...
{\bfseries ARCHITECTURE AND APPLICATION OF A BIOTECHNICAL SYSTEM FOR HUMAN
PSYCHOPHYSIOLOGICAL TESTING}

{\bfseries \tsp{1}A.T.Mazakova}\fig{i/image1}[]{\bfseries ,
\tsp{1}Sh.A.Jomartova}\fig{i/image1}[]{\bfseries ,\tsp{1,2}
T.Zh.Mazakov}\fig{i/image1}[]
{\bfseries \envelope ,\tsp{3}B.Zhao}\fig{i/image1}[],

{\bfseries \tsp{1}A.M.Abubakirov}\fig{i/image1}[]

\emph{{\bfseries \tsp{1}}Al-Farabi Kazakh National University,
Almaty, Kazakhstan,}

\emph{{\bfseries \tsp{2}}International University of
Engineering and Technology, Almaty, Kazakhstan,}

\emph{{\bfseries \tsp{3}} Dalian Polytechnic University,
Dalian, China}

\envelope Corresponding author: tmazakov@mail.ru
...
psychological testing, followed by intelligent data processing. The
...
primary processing module, a data transmission interface, and a software
...
photoplethysmogram analysis, calculation of heart rate variability
...
{\bfseries Адамның психофизиологиялық тестілеуіне арналған биотехникалық
жүйенің архитектурасы және қолданылуы}

{\bfseries \tsp{1}А.Т. Мазакова,
\tsp{1}Ш.А.Джомартова,\tsp{1,2}Т.Ж.
Мазаков\envelope , \tsp{3} Б.Чжао,}

{\bfseries \tsp{1}А.М.Абубакиров}
...
\emph{\tsp{3}Далянь политехникалық университеті, Далянь,
Қытай,}

e-mail: \href{mailto:tmazakov@mail.ru}{\ul{tmazakov@mail.ru}}
...
{\bfseries АРХИТЕКТУРА И ПРИМЕНЕНИЕ БИОТЕХНИЧЕСКОЙ СИСТЕМЫ
ПСИХОФИЗИОЛОГИЧЕСКОГО ТЕСТИРОВАНИЯ ЧЕЛОВЕКА}
...
\emph{{\bfseries \tsp{3}}Даляньский политехнический
...
{\bfseries Fig.1- Scheme of interaction between the BTS operator and the
subject}

\fig{i/image15}[]

{\bfseries Fig.2 - Scheme of processing testing results by a psychologist}
...
Чжао Байдун \emph{-} старший преподаватель, Даляньский политехнический
