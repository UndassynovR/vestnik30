...
\begin{quote}
{\bfseries ADAPTIVE NONLINEAR CONTROL OF SPACECRAFT ATTITUDE USING NEURAL
NETWORKS}
\end{quote}

{\bfseries \tsp{1}M.A.
Bisenbi}\fig{i/image1}[]{\bfseries ,
\tsp{1}O.G.Abdiramanov}\fig{i/image1}[]{\bfseries \envelope ,
\tsp{2}M.B.}
{\bfseries Rakhimzhanova}\fig{i/image1}[],
{\bfseries \tsp{3}G.B.
Balgozhina}\fig{i/image1}[],

{\bfseries \tsp{2}G.S.
Shuteyeva}\fig{i/image1}[]{\bfseries ,
\tsp{1}D.C.Zhamangarin}\fig{i/image1}[]

\emph{{\bfseries \tsp{1}}Eurasian National University named by
L.N. Gumilyev, Astana, Kazakhstan,}

\emph{{\bfseries \tsp{2}}Astana IT University, Astana,
Kazakhstan,}

\emph{{\bfseries \tsp{3}}Abai Kazakh National Pedagogical
...
capable of attaining quicker convergence, better robustness, and lower
...
{\bfseries АДАПТИВНОЕ НЕЛИНЕЙНОЕ УПРАВЛЕНИЕ ПОЛОЖЕНИЕМ КОСМИЧЕСКОГО
ЛЕТАТЕЛЬНОГО АППАРАТА С ИСПОЛЬЗОВАНИЕМ НЕЙРОННЫХ СЕТЕЙ}

{\bfseries \tsp{1}М.А. Бейсенби, \tsp{1}Ө.Ғ.
Әбдіраманов\envelope , \tsp{2}М.Б. Рахимжанова,
\tsp{3}Г.Б. Балгожина,}

{\bfseries \tsp{2}Г.С. Шутеева, \tsp{1}Д.С.
Жамангарин}

{\bfseries \tsp{1}}\emph{Евразийский Национальный университет
имени Л.Н.Гумилева, Астана, Казахстан,}

{\bfseries \tsp{2}}\emph{Astana IT University, Астана,
Казахстан,}

{\bfseries \tsp{3}}\emph{Казахский национальный педагогический
университет им. Абая, Астана, Казахстан,}
...
{\bfseries НЕЙРОНДЫҚ ЖЕЛІЛЕРДІ ҚОЛДАНА ОТЫРЫП, ҒАРЫШТЫҚ ҰШУ АППАРАТТАРЫНЫҢ
ОРНАЛАСУЫН АДАПТИВТІ СЫЗЫҚТЫҚ ЕМЕС БАСҚАРУ}
...
{\bfseries \tsp{1}}\emph{Л.Н.Гумилев атындағы Еуразия Ұлттық
университеті, Астана, Қазақстан,}

{\bfseries \tsp{2}}\emph{Astana IT University, Астана,
Қазақстан,}

{\bfseries \tsp{3}}\emph{Абай атындағы Қазақ Ұлттық
Педагогикалық университеті, Астана, Қазақстан,}
...
\[\dot{x} = f(x) + g(x)u + \mathrm{\Delta}(x,t)\ \ \ \ (2)\]
...
\(\mathrm{\Delta}(x,t)\) denotes the lumped uncertainty, including
...
\(\mathrm{\Delta}(x,t)\), a neural network (NN) approximator is
introduced to estimate the unknown dynamics online. The NN is defined
as:

\[\widehat{f}(x) = W^{Τ}\varphi(x)\ \ \ \ (3)\]
...
\[\varepsilon(x) = f(x) - \widehat{f}(x)\ \ \ (4)\]
...
\(J\dot{\omega} + \omega \times (J\omega) = u + d + \tau_{f}\) (5)
...
\[\dot{q} = \left( \frac{1}{2} \right)Q(q)\omega\ \ \ (6)\]
...
\[\widehat{W} = \Gamma\varphi(x)s^{Τ}\ \ \ \ \ (9)\]
...
Γ = diag (10, 10, 10) and K = diag (4.5, 4.0, 3.8)
...
\begin{quote}
\fig{i/image73}[]Attitude
stabilization result
\end{quote}

{\bfseries Fig.1 - Convergence of the orientation error}
...
\begin{quote}
\fig{i/image74}[]Flexible
vibration suppression
\end{quote}

{\bfseries Fig.2 - Flexible battery tip deflection response}
