...
\tsp{1}A.~Tulegulov,
\tsp{1}A.~Jumagaliyeva\envelope,
\tsp{1}A.~Sadu,
\tsp{1}В.~Yemilov,
\tsp{1}M.~Nurmagambetov,
\tsp{1}J.~Zhantlesov,
\tsp{2}I.~Dyussebayev
\end{header}
...
\fig[0.5\textwidth]{i/image93}[Fig.5 - Powder Bed Fusion Physical Manufacturing Cycle]
...
\fig[0.5\textwidth]{i/image96}[Fig.7 - Morphology of gear wear particles revealed by optical
microscopy]
...
\fig{i/image97}[Fig.8 - Photograph of sample images of a gear]
