...
\begin{header}
\swa{B.B.~Orazbayev, N.N.~Seit}{DEVELOPMENT OF MATHEMATICAL MODELS OF THE MAIN UNITS OF THE SULFUR PRODUCTION UNIT BASED ON SYSTEM ANALYSIS}

B.B.~Orazbayev\alink{https://orcid.org/0000-0003-2109-6999},
N.N.~Seit\alink{https://orcid.org/0009-0002-4772-8851}\envelope
\end{header}

\begin{affil}
L.N.Gumilyov Eurasian National University, Astana, Kazakhstan

\corrauthor{Corresponding author: nurgulnurmash@gmail.com}
\end{affil}
...
available information. This methodology is demonst\-rated through the
...
reactor outlets and their input and operating param\-eters were identified
as a system of multiple regression equations, using aggregated
experimental, statisti\-cal, and expert data, along with the sequential
...
\begin{header}
КҮКІРТ ӨНДІРУ БЛОГЫ НЕГІЗГІ АГРЕГАТТАРЫНЫҢ МАТЕМАТИКАЛЫҚ МОДЕЛЬДЕР КЕШЕНІН ЖҮЙЕЛІК ТАЛДАУ НЕГІЗІНДН ҚҰРУ
...
e-mail: nurgulnurmash@gmail.com
\end{affil}
...
\begin{header}
РАЗРАБОТКА МАТЕМАТИЧЕСКИХ МОДЕЛЕЙ ОСНОВНЫХ АГРЕГАТОВ БЛОКА ПРОИЗВОДСТВА СЕРЫ НА ОСНОВЕ СИСТЕМНОГО АНАЛИЗА
...
the outlets of the thermal reactors and the Claus reactor (\(y_{j},\ j
= 1,2\)) , as well as the fuzzy indicators characterizing sulfur
quality, namely the mass fraction of sulfur and the mass fraction
(\({\widetilde{y}}_{j},\ j = 3,4\)) of water in the product obtained
from the Claus reactor.
...
\tcap{Table 1 - Results of the Systematic Analysis of Possible Model
Types for the Main Units of the Sulfur Production Block}
\begin{longtblr}[
  label = none,
  entry = none,
  note{} = {\emph{Note: The evaluation (ranking) uses a score scale (1-5), where 1
represents the lowest score and 5 the highest. The scores may be fuzzy,
i.e., expressed as fuzzy numbers.}},
]{
  width = \linewidth,
  colspec = {Q[30]Q[150]Q[350]Q[50]Q[50]Q[50]Q[50]},
  cells = {font = \small},
  row{1} = {c},
  row{2} = {c,font=\bfseries\small},
  cell{1}{1} = {r=2}{},
  cell{1}{2} = {r=2}{font=\bfseries\small},
  cell{1}{3} = {r=2}{font=\bfseries\small},
  cell{1}{4} = {c=4}{0.232\linewidth,font=\bfseries\small},
  cell{3}{1} = {c},
  cell{3}{2} = {c},
  cell{3}{3} = {c},
  cell{3}{4} = {c},
  ...
  cell{9}{7} = {c},
  cell{10}{1} = {c},
  cell{10}{4} = {c,font=\bfseries\small},
  cell{10}{5} = {c,font=\bfseries\small},
  cell{10}{6} = {c,font=\bfseries\small},
  cell{10}{7} = {c,fg=blue,font=\bfseries\small},
  cell{11}{1} = {c},
  cell{11}{2} = {r=6}{},
  cell{11}{4} = {c},
  cell{11}{5} = {c},
  ...
  cell{16}{7} = {c},
  cell{17}{1} = {c},
  cell{17}{4} = {c,font=\bfseries\small},
  cell{17}{5} = {c,fg=blue,font=\bfseries\small},
  cell{17}{6} = {c,font=\bfseries\small},
  cell{17}{7} = {c,font=\bfseries\small},
  cell{18}{1} = {c},
  cell{18}{2} = {r=5}{},
  cell{18}{4} = {c},
  cell{18}{5} = {c},
  ...
  cell{23}{7} = {c},
  cell{24}{1} = {c},
  cell{24}{4} = {c,font=\bfseries\small},
  cell{24}{5} = {c,fg=blue,font=\bfseries\small},
  cell{24}{6} = {c,font=\bfseries\small},
  cell{24}{7} = {c,font=\bfseries\small},
  cell{25}{1} = {c},
  cell{25}{2} = {r=5}{},
  cell{25}{4} = {c},
  cell{25}{5} = {c},
  ...
  cell{30}{7} = {c},
  cell{31}{1} = {c},
  cell{31}{4} = {c,font=\bfseries\small},
  cell{31}{5} = {c,fg=blue,font=\bfseries\small},
  cell{31}{6} = {c,font=\bfseries\small},
  cell{31}{7} = {c,font=\bfseries\small},
  cell{32}{1} = {c},
  cell{32}{2} = {r=5}{},
  cell{32}{4} = {c},
  cell{32}{5} = {c},
  ...
  cell{37}{7} = {c},
  cell{38}{1} = {c},
  cell{38}{4} = {c,fg=blue,font=\bfseries\small},
  cell{38}{5} = {c,font=\bfseries\small},
  cell{38}{6} = {c,font=\bfseries\small},
  cell{38}{7} = {c,font=\bfseries\small},
  hlines,
  vlines,
}
№   & Main units of the sulfur production block      & Criteria                                    & Types of Models                             &                                           &                                     &                                        \\
    &                                                &                                             & \begin{sideways}Deterministic\end{sideways} & \begin{sideways}Statistical\end{sideways} & \begin{sideways}Fuzzy\end{sideways} & \begin{sideways}Composed\end{sideways} \\
1   & 2                                              & 3                                           & 4                                           & 5                                         & 6                                   & 7                                      \\
1.1 & {\textbf{Reactors}\\(R-001,\\R-002,\\R-003)}   & Availability of required information        & 2.5                                         & 4.5                                       & 4.5                                 & 5.0                                    \\
...
1.5 &                                                & Possibility of integration into one package & 4.0                                         & 3.5                                       & 3.5                                 & 3.5                                    \\
1.6 &                                                & Model adequacy                              & 3.0                                         & 3.5                                       & 3.5                                 & 4.0                                    \\
    &                                                & Sum of prices                               & 18.5                                        & 22.5                                      & 21.5                                & 24.5                                   \\
2.1 & {\textbf{Capacitors}\\(Е-001,\\Е-002,\\Е-004)} & Availability of required information        & 3.5                                         & 4.5                                       & 4.0                                 & 4.0                                    \\
...
2.5 &                                                & Possibility of integration into one package & 4.5                                         & 4.0                                       & 4.0                                 & 4.0                                    \\
2.6 &                                                & Model adequacy                              & 3.5                                         & 3.5                                       & 3.5                                 & 3.5                                    \\
    &                                                & Sum of prices                               & 21.5                                        & 23.5                                      & 22.5                                & 22.5                                   \\
3.1 & {\textbf{Oven}\\(F-002)}                       & Availability of required information        & 4.0                                         & 5.0                                       & 4.5                                 & 4.0                                    \\
...
3.5 &                                                & Possibility of integration into one package & 4.0                                         & 4.5                                       & 4.0                                 & 5.0                                    \\
3.6 &                                                & Model adequacy                              & 4.0                                         & 4.5                                       & 4.5                                 & 5.0                                    \\
    &                                                & Sum of prices                               & 23.5                                        & 27.5                                      & 24.5                                & 25.0                                   \\
4.1 & {\textbf{Separators} (D-001,\\D-004)}          & Availability of required information        & 4.5                                         & 5.0                                       & 4.0                                 & 4.5                                    \\
...
4.5 &                                                & Possibility of integration into one package & 3.5                                         & 4.0                                       & 3.5                                 & 4.0                                    \\
4.6 &                                                & Model adequacy                              & 4.0                                         & 4.0                                       & 3.5                                 & 4.0                                    \\
    &                                                & Sum of prices                               & 23.5                                        & 27.0                                      & 21.5                                & 23.5                                   \\
5.1 & {\textbf{Extractors}\\(B-001,\\B-002)}         & Availability of required information        & 4.5                                         & 4.0                                       & 4.0                                 & 4.5                                    \\
...
5.5 &                                                & Possibility of integration into one package & 4.5                                         & 4.0                                       & 4.0                                 & 4.0                                    \\
5.6 &                                                & Model adequacy                              & 4.5                                         & 4.0                                       & 4.0                                 & 4.5                                    \\
    &                                                & Sum of prices                               & 28.0                                        & 25.0                                      & 24.0                                & 26.0                                   
\end{longtblr}
...
\begin{equation*}
\begin{split}
y_{TR} = f_{1}(x_{1}, x_{2}, x_{4}) = &0.686792 x_{1} + 0.012480 x_{2} + 0.052000 x_{3} + 0.260000 x_{4} \\
&+ 0.025917 x_{1}^{2} + 0.0000090 x_{2}^{2} + 0.0002080 x_{3}^{2} + 0.00005200 x_{4}^{2} \\
&+ 0.000471 x_{1} x_{2} + 0.000589 x_{1} x_{4} + 0.0000250 x_{2} x_{4} + 0.000104 x_{3} x_{4}
\end{split}
\end{equation*}

\begin{equation*}
\begin{split}
y_{RC} = f_{2}(x_{5}, x_{6}, x_{7}) = &0.6712330 x_{5} + 0.0171430 x_{6} + 0.0129230 x_{7} \\
&+ 0.0788140 x_{5}^{2} + 0.000058 x_{6}^{2} + 0.00003 x_{7}^{2} \\
&+ 0.000035 x_{5} x_{6} + 0.000589 x_{5} x_{7} + 0.0000250 x_{6} x_{7}
\end{split}
\end{equation*}

\begin{multicols}{2}
The unknown fuzzy regression coefficients
\({\widetilde{a}}_{0},{\widetilde{a}}_{i},\ i =\overline{5,7}\)
and \(\tilde{a}_{ik}, \ i = \overline{5,7}, \ k = \overline{i,7};\)
...
As an example, we present \({\widetilde{y}}_{S}\)
...
\small
\begin{split}
\tilde{y}_{S} = f_{3}(x_{5}, x_{6}, x_{7}) =
&(0.5/0.037008 + 0.75/0.037020 + 1/0.037033 + 0.75/0.037045 + 0.5/0.037057) \\
&\quad \cdot x_{5} + (0.5/0.076885 + 0.75/0.076900 + 1/0.076915 + 0.75/0.076930 \\
&\quad + 0.5/0.076945) x_{6} - (0.5/0.169430 + 0.75/0.169455 + 1/0.169475 \\
&\quad + 0.75/0.169495 + 0.5/0.169520) x_{7} + (0.5/0.000010 + 0.75/0.000020 \\
&\quad + 1/0.000027 + 0.75/0.000034 + 0.5/0.000044) x_{5}^{2} + (0.5/0.000093 \\
&\quad + 0.75/0.000108 + 1/0.000118 + 0.75/0.000128 + 0.5/0.000143) x_{6}^{2} \\
&\quad - (0.5/0.000007 + 0.75/0.000057 + 1/0.000574 + 0.75/0.000157 \\
&\quad + 0.5/0.000207) x_{7}^{2} + (0.5/0.000050 + 0.75/0.000070 + 1/0.000080 \\
&\quad + 0.75/0.000090 + 0.5/0.00011) x_{5} x_{6} - (0.5/0.000045 + 0.75/0.000065 \\
&\quad + 1/0.000075 + 0.75/0.000085 + 0.5/0.000105) x_{5} x_{7} \\
&\quad - (0.5/0.000174 + 0.75/0.000199 + 1/0.000209 + 0.75/0.000219 \\
&\quad + 0.5/0.000244) x_{6} x_{7}
\end{split}
\end{equation}
...
-P.152-166. \href{https://doi.org/10.1016/j.mcm.2011.12.002}{DOI
10.1016/j.mcm.2011.12.002}.

4. Нәдіров Н.К., Сармурзина Р.Ғ., Оразбаева К.Н. Мұнай өңдеу, мұнай
...
7. Анчита Х. Переработка тяжелой нефти. Реакторы и моделирование
процессов//Пер.с англ. под ред. Глаголевой О.Ф., Винокурова В.А.
Издательство Профессия. -2015. -592 c. ISBN 978-5-91884-068-9.

8. Беккер В.Ф. Моделирование химико-технологических объектов управления:
...
10. Акопов А.С. Имитационное моделирование: учебник и практикум для
вузов. -2-е изд.// М.: Издательство Юрайт. - 2024. - 426 c.
ISBN~978-5-534-18379-5.~

11. Кобелев Н.Б., Девятков В.В., Половников В.А. Имитационное
моделирование: учебник. -2-е издание// КУРС. -2024. - 353c. ISBN
978-5-907228-65-8.

12. Воробьев С.Н., Гирина Н.В., Лазарев И.В., Осипов Л.А. Статистическое
...
Astana, Kazakhstan, e-mail: nurgulnurmash@gmail.com.
...
имени Л. Н. Гумилёва, Астана, Казахстан, e-mail: nurgulnurmash@gmail.com.
\end{info}
