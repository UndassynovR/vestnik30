...
Materials and methods. The initial data of the study are the production
...
Fig.7 - Predicted vs Actual (after implementation)
...
Fig.8 - Error distribution before implementation
...
Fig.9 - Error distribution after implementation
...
\(E\_ g\  = \ k\  \cdot \ V\  \cdot \ \Delta c\) (15)
...
\(CF\_ 0\  = \  - CAPEX,\ \ CF\_ t\  = \ E\_ n\ \ (t = 1\ldots T)\) (17)
...
\(\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ NPV\  = \ \Sigma\_\{ t = 0\}\hat{}\{ T\}\ (CF\_ t\ /\ (1 + r)\hat{}t)\)
(18)
...
\(PP\  = \ min\ \{\ t\ :\ \Sigma\_\{ i = 0\}\hat{}\{ t\}\ (CF\_ i\ /\ (1 + r)\hat{}i)\  \geq \ 0\ \}\)
(19)
...
Table 1 -- Scenario parameters and calculation results

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.1202}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0876}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0958}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0734}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0882}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0914}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0922}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0994}}
...
%%   >{\raggedright\arraybackslash}p{(\linewidth - 20\tabcolsep) * \real{0.0648}}@{}}
%% \toprule\noalign{}
...
%% OPEX, USD/год
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% Annual effect (gross), USD
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% Annual effect (net),USD
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% NPV, USD
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
%% Payback (disk.), year
...
%% \bottomrule\noalign{}
%% \endlastfoot
%% Conservative & 500000 & 0.3 & 0.8 & 1200000 & 120000 & 120000.0 & 0.0 &
%% 1200000.0 & - & 100.0 \\
%% Basic & 1200000 & 0.4 & 1.5 & 1200000 & 150000 & 720000.0 & 570000.0 &
%% 854722.0 & 3.0 & 137.5 \\
%% \end{longtable}
...
Fig.11- Payback schedule (accumulated discounted cash flow), "Baseline"
scenario
...
Conclusion. The testing of the data integration and forecasting platform
...
Акишева Л.- Назарбаев интеллектуальная школа, Астана, Казахстан, e-mail:
lenaraakisheva@gmail.com;
