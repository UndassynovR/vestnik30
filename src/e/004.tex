...
{\bfseries THE NATURAL RESOURCE CURSE IN KAZAKHSTAN: ECONOMIC AND
STRUCTURAL PROBLEMS AND SOLUTION PROPOSALS}

{\bfseries \tsp{1}G.P.Koptayeva}\fig{e/image1}[]{\bfseries ,\tsp{2}A.B.Mukhamedkhanova}\fig{e/image1}[]
{\bfseries \envelope  ,
\tsp{3}A.N.Issakhmetova}\fig{e/image1}[]{\bfseries ,\tsp{1}G.A.Myrzalieva}\fig{e/image1}[],

{\bfseries \tsp{4}A.A.Mutaliyeva}\fig{e/image1}[]{\bfseries ,
\tsp{5}D.N.Kelesbayev}\fig{e/image1}[]

\emph{\tsp{1}Miras University, Shymkent, Kazakhstan,}

\emph{\tsp{2}M. Auezov South Kazakhstan University,
Shymkent, Kazakhstan,}

\emph{\tsp{3}Central-Asian Innovation University, Shymkent,
Kazakhstan,}

\emph{\tsp{4}Regional Innovation University, Shymkent,
Kazakhstan,}

\emph{\tsp{5}Akhmet Yassawi University, Turkestan,
Kazakhstan}

\envelope Correspondent-author: Dia-2808@mail.ru
...
{\bfseries ҚАЗАҚСТАНДАҒЫ ТАБИҒИ РЕСУРСТАРДЫҢ ҚАРҒЫСЫ: ЭКОНОМИКАЛЫҚ ЖӘНЕ
ҚҰРЫЛЫМДЫҚ МӘСЕЛЕЛЕР ЖӘНЕ ШЕШІМ ҰСЫНЫСТАРЫ}

{\bfseries \tsp{1}Г.П.Коптаева,
\tsp{2}А.Б.Мухамедханова\envelope ,
\tsp{3}А.Н.Исахметова, \tsp{1}Г.А.Мырзалиева,}

{\bfseries \tsp{4}А.А.Муталиева,
\tsp{5}Д.Н.Келесбаев}

\emph{\tsp{1}Мирас университеті, Шымкент, Қазақстан,}

\emph{\tsp{2}М.Әуезов атындағы Оңтүстік Қазақстан
университеті, Шымкент, Қазақстан,}

\emph{\tsp{3}Орталық Азия инновациялық университеті,
Шымкент, Қазақстан,}

\emph{\tsp{4}Аймақтық инновациялық университеті, Шымкент,
Қазақстан,}

\emph{\tsp{5}Ахмет Ясауи университеті, Түркістан,
Қазақстан,}
...
{\bfseries ПРОКЛЯТИЕ ПРИРОДНЫХ РЕСУРСОВ В КАЗАХСТАНЕ: ЭКОНОМИЧЕСКИЕ И
СТРУКТУРНЫЕ ПРОБЛЕМЫ И ПРЕДЛОЖЕНИЯ ПО РЕШЕНИЮ}

{\bfseries \tsp{1}Г.П.Коптаева,
\tsp{2}А.Б.Мухамедханова, \tsp{3}А.Н.Исахметова,
\tsp{1}Г.А.Мырзалиева,}

{\bfseries \tsp{4}А.А.Муталиева,
\tsp{5}Д.Н.Келесбаев\envelope }

\emph{\tsp{1}Университет Мирас, Шымкент, Казахстан,}

\emph{\tsp{2}Южно-Казахстанский университет имени М.Ауэзова,
Шымкент, Казахстан,}

\emph{\tsp{3}Центрально-Азиатский инновационный университет,
Шымкент, Казахстан,}

\emph{\tsp{4}Региональный инновационный университет,
Шымкент, Казахстан,}

\emph{\tsp{5}Университет Ахмеда Ясави, Туркестан,
Казахстан,}
...
{\bfseries Table 1 - Some Macroeconomic Indicators of Kazakhstan}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1212}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2576}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2122}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.1818}}
%%   >{\centering\arraybackslash}p{(\linewidth - 8\tabcolsep) * \real{0.2272}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\raggedright
%% {\bfseries Years}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries GDP (Billion Dollars)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Growth Rate (\%)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Inflation (\%)}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Unemployment (\%)}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
...
GDP/Natural Resource Revenues to GDP Ratio Graph
...
Ratio of Natural Resource Revenues to GDP (\%)
...
{\bfseries Fig.1 - GDP/Ratio of Natural Resource Revenues to GDP}
...
{\bfseries Table 2 - Macroeconomic Policies Implemented by Kazakhstan}

%% \begin{longtable}[]{@{}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.2970}}
%%   >{\raggedright\arraybackslash}p{(\linewidth - 2\tabcolsep) * \real{0.7030}}@{}}
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Policies}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Explanations}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% Monetary Policy Improvements & To control inflation, the Central Bank
%% increased interest rates and tightened the money supply. \\
%% Budget Discipline Practices & The government implemented policies that
%% strengthened budget discipline to balance expenditures and revenues. \\
%% Fiscal Reforms & Reforms were implemented to review the tax system,
%% broaden the tax base, and increase tax compliance. \\
%% Inflation Targeting & The Central Bank set a specific inflation target
%% and shaped its monetary policies to achieve this target. \\
%% Restructuring Social Assistance & To reduce budget deficits, social
%% assistance programs were reviewed, and regulations were implemented to
%% ensure more efficient use of resources. \\
%% Expenditure Cuts & Public spending was cut and redirected to priority
%% projects. \\
%% Policies to Encourage Domestic Production & Various incentives were
%% provided to encourage domestic production, reduce foreign exchange
%% demand, and reduce import dependency. \\
%% Control over Exchange Rates & The Central Bank intervened using its
%% foreign exchange reserves to control exchange rate fluctuations. \\
%% Use of International Financing Sources & The aim was to secure and
%% restructure financial resources through cooperation with international
%% financial institutions. \\
%% Economic Stabilization Programs & Various economic stability programs
%% were developed to control inflation and ensure fiscal discipline. \\
%% \end{longtable}
...
{\bfseries Table 3 - SWOT Analytical Synthesis Table}
...
%% \toprule\noalign{}
%% \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Analytical Dimension}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Key Findings}
%% \end{minipage} & \begin{minipage}[b]{\linewidth}\centering
%% {\bfseries Strategic Implication}
%% \end{minipage} \\
%% \midrule\noalign{}
%% \endhead
%% \bottomrule\noalign{}
%% \endlastfoot
%% Strengths & Large natural resource reserves & Can finance
%% diversification if managed effectively \\
%% Weaknesses & Lack of economic diversification & Structural reforms
%% required \\
%% Opportunities & Renewable energy potential & Green transition
%% strategy \\
%% Threats & Oil price volatility & Need for resilient economic
%% structure \\
%% \end{longtable}
...
Development.-2008.-Vol.36(3).-P.399-419.
...
2024 Article IV Consultation with the Republic of Kazakhstan. - 2024. -
URL:
\url{https://www.imf.org/en/news/articles/2025/01/30/pr25021-kazakhstan-executive-board-concludes-2024-article-iv-consult}.
...
Koptayeva G.P. - Candidate of Economic Sciences, Senior Lecturer, Miras
University, Shymkent, Kazakhstan, e-mail: asel\_4747@mail.ru;

Mukhamedkhanova A.B. - Doctoral Student, M. Auezov South Kazakhstan
University, Shymkent, Kazakhstan, e-mail: Dia-2808@mail.ru;

Issakhmetova A.N. - Candidate of Economic Sciences, Associate Professor,
Central Asian Innovative University, Shymkent, Kazakhstan, e-mail:
i\_a\_n@inbox.ru;

Myrzalieva G.A - Candidate of Economic Sciences, Senior Lecturer, Miras
University, Shymkent, Kazakhstan, e-mail: k.i.myrzalieva@yandex.ru;
...
М.Ауэзова, Шымкент, Казахстан, е-mail:
Dia-2808@mail.ru;
