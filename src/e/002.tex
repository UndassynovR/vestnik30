...
\begin{header}
\swa{M.~Yerbatyrov, M.~Zhetpisbayeva, Zh.~Vladimirov, G.~Baidauletova}{EXPLAINING THE GAP BETWEEN INTEREST AND APPLICATION INTENTION IN PUBLIC SECTOR EMPLOYMENT}

\tsp{1}M.~Yerbatyrov,
\tsp{1}M.~Zhetpisbayeva,
\tsp{2}Zh.~Vladimirov,
\tsp{3}G.~Baidauletova\envelope
\end{header}

\begin{affil}
\tsp{1}Karaganda university of Kazpotrebsoyuz, Karaganda, Kazakhstan,

\tsp{2}Sofia University «St. Kliment Ohridski», Sofia, Bulgaria,

\tsp{3}Shymkent University, Shymkent, Kazakhstan

\corrauthor{Corresponding author: gulnur.baidauletova@mail.ru}
\end{affil}
...
\begin{header}
ОБЪЯСНЕНИЕ РАЗРЫВА МЕЖДУ ИНТЕРЕСОМ И НАМЕРЕНИЕМ ПОДАТЬ ЗАЯВКУ НА РАБОТУ В ГОСУДАРСТВЕННОМ СЕКТОРЕ

\tsp{1}М.~Ербатыров,
\tsp{1}М.~Жетписбаева,
\tsp{2}Ж.~Владимиров,
\tsp{3}Г.О.~Байдаулетова\envelope
\end{header}

\begin{affil}
\tsp{1}Карагандинский университет «Казпотребсоюза», Караганда, Казахстан,

\tsp{2}Софийский университет «Св. Климент Охридского», София, Болгария,

\tsp{3}Шымкентский университет, Шымкент, Казахстан,

e-mail: gulnur.baidauletova@mail.ru
\end{affil}
...
\begin{header}
МЕМЛЕКЕТТІК СЕКТОРДАҒЫ ЖҰМЫСҚА ҚЫЗЫҒУШЫЛЫҚ ПЕН ӨТІНІШ БЕРУ НИЕТІНІҢ АРАСЫНДАҒЫ АЛШАҚТЫҚТЫ ТҮСІНДІРУ
...
\begin{affil}
\tsp{1}«Қазтұтынуодағы» Қарағанды университеті, Қарағанды, Қазақстан,

\tsp{2}Әулие Климент Охрид атындағы София университеті, София, Болгария,

\tsp{3}Шымкент университеті, Шымкент, Қазақстан
...
\tcap{Table 1 - Sample characteristics (N = 196)}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
Year of study                                    & 1st (7), 2nd (8), 3rd (98), 4th (83) & 4 / 4 / 50 / 42 \\
...
\tcap{Table 2 - Descriptive statistics for interest indicators}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 3 - Spearman correlations (ρ) between values and interest indicators}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
Orientation                                      & Attr. & Accept & Apply & Relocate & Consider \\
...
\tcap{Table 4 - Exploratory factor analysis of attitudinal items (N = 196)}
\begin{longtblr}[
  label = none,
  entry = none,
]{
  width = \linewidth,
  colspec = {Q[292]Q[177]Q[175]Q[325]},
  cells = {c},
  cells = {font = \small},
  row{1} = {font=\bfseries\small},
  cell{13}{1} = {c=4}{},
...
Item                                             & General Evaluation & Mission  Prestige & Material  Organizational Conditions \\
...
\tcap{Table 5 - Multiple linear regression predicting overall interest}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
Predictor                                        & Std. β & SE   & P value \\
Mission  prestige                                & 0,43   & 0,06 &  0,001  \\
Material  organizational conditions              & 0,25   & 0,07 &  0,01   \\
...
\tcap{Table 6 - Logistic regression estimates of application intention (N = 196)}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
9.Nina Vari van Loon, W. Vandenabeele, P. Leisink. Clarifying the
...
\href{https://www.rechtswissenschaft.unibe.ch/unibe/portal/fak\_rechtwis/content/e6024/e6025/e118744/e1190006/e1416330/pane1727015/e1416332/files1416356/MA\_Eslami\_Taheri\_23.01.2023\_ger.pdf}{https://www.rechtswissenschaft.unibe.ch}.-
...
Karaganda, Kazakhstan, e-mail: yerbatyr.meirambek@gmail.com;
...
Baidauletova G.- Master, senior lecturer, Shymkent University,
Shymkent, Kazakhstan, e-mail: super\_khan@mail.ru.

\hspace{1em}\emph{{\bfseries Сведения об авторах}}

Ербатыров М.- PhD докторант, Карагандинский университет
...
университет, Шымкент, Казахстан, e-mail: super\_khan@mail.ru.
\end{info}
